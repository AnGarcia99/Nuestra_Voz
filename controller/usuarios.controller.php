                    ...
                    if ($User['Login'] == 'admin') {
                        ...
                        if ($User['EdoCta'] == 1) {
                            ...
                            if ($now >= $FecIni) {
                                ...
                                echo '<br><div class="alert alert-danger">Error a ingresar, cuenta aún no activa</div>';
                            }
    
                        } else {
                            echo '<br><div class="alert alert-danger">Error a ingresar, cuenta inactivo.</div>';
                        }
                    }
        ...
        if (isset($_POST['action'])) {
            ...
            foreach ($Users as $value) {
                ...
                $rows = $rows."<tr $attributes $id>
                                   ...
                                   <td>$value[5]</td>";
                                if ($value[6] == 1) {
                $rows = $rows.     '<td><span class="btn btn-success btn-xs" style="height: 15px; width: 15px; border-radius: 50%; text-align: left;"></span></td>';
                                } else {
                $rows = $rows.     '<td><span class="btn btn-danger btn-xs" style="height: 15px; width: 15px; border-radius: 50%; text-align: left;"></span></td>';
                                }
                $rows = $rows.     "</tr>";
            }
