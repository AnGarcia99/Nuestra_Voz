$(document).ready(function () {
    ...
    function getCatalogs() {    
        ...
        $.ajax({
            ...
            type: 'POST',
            url: 'controller/catalogs.controller.php',
            data: {
        ...
        if (boton.text() == 'Grabar') {
            ...
            if (validateRepeat(catalogo, descripcion, [Cv, Ds])) {
                ...
                swal({
                    type: "error",
                    title: "¡Error!",
                    text: "El dato se encuentra repetido",
                    background: '#222D32',
                    showConfirmButton: true,
                    confirmButtonText: "Cerrar"
                }); 
        ...
        $.ajax({
            ...
            if (res == 'true') {
                ...
                swal({
                    type: "error",
                    title: "Dato Repetido",
                    text: "¡El dato esta siendo usado en la tabla maestra!",
                    background: '#222D32',
                    showConfirmButton: true,
                    confirmButtonText: "Cerrar"
                });
