...
function addNewUser() {
    ...
    if ($('#nuevo').text() == 'Nuevo') {
        ...
        $('#Password').attr('placeholder', 'Introduzca una Contraseña');
        ...
        $.ajax({
            ...
            if (res == 'username') {
                ...
                swal({
                    type: "error",
                    title: '¡Error!',
                    text: 'Ya existe un registro con este usuario',
                    background: '#222D32',
                ...
                swal({
                    type: "error",
                    title: '¡Error!',
                    text: 'Ya existe una registro con esta contraseña',
                    background: '#222D32',
                    showCancelButton: false,
                    confirmButtonColor: '#3085d6',
                    confirmButtonText: 'Aceptar'
...
function errors_msg(errors) {
    ...
    errors.forEach(element => {
        ...
        if (element == 'FecIniError' || element == 'FecFinError') {
            $('#' + element).css('display', 'inline').css('margin-left', '38%').css('margin-right', '50%');
        } else {
            $('#' + element).css('display', 'inline').css('margin-left', '42%').css('margin-right', '12%');
        }
